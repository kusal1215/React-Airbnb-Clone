    ...
    return (
        ...
        bg-white shadow-md p-5 md:px-10">
            ...
            <div className="flex items-center rounded-full py-2 md:border-2 md:shadow-sm">
                ...
                <input className="pl-5 bg-transparent outline-none flex-grow text-sm text-gray-600" type="text" 
                placeholder="Start your search"/>

                <SearchIcon className="h-8 bg-red-400 text-white
                rounded-full p-2 cursor-pointer hidden md:inline-flex mx-2"/>
